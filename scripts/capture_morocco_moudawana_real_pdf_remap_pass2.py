"""Capture screenshots for F-morocco-moudawana-real-pdf-remap-pass2.

Confirm the public surface still presents the right MA messaging
after the mapping draft has been regenerated from the real
Moudawana PDF: the calculator stays
...
OUTDIR = REPO_ROOT / "docs" / "screenshots" / "live_qa" / "morocco_moudawana_real_pdf_remap_pass2"
...
DESKTOP = [
    ...
    ("04_country_morocco_ar", "/ar", "/countries/morocco/", None),
    ("05_wizard_ma_inheritance_ar", "/ar", "/wizard/ma/inheritance/", None),
    ("06_result_ma_unavailable_ar", "/ar", "/wizard/ma/inheritance/", MA_PAYLOAD),
]
