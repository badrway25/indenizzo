"""Capture screenshots for F-morocco-moudawana-livre-iii-mapping-draft-pass1.

Confirm the public surface still presents the right MA messaging
after the mapping draft was committed: the calculator stays
...
OUTDIR = REPO_ROOT / "docs" / "screenshots" / "live_qa" / "morocco_moudawana_mapping_draft_pass1"
